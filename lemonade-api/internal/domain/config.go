...
func DefaultConfig() Config {
	return Config{
		...
		WarehouseTiers: []Tier{
			{Name: "Pantry", Size: 10, BuildCost: 100, UpgradeCost: 100, Upkeep: 1},
			{Name: "Garage", Size: 20, BuildCost: 300, UpgradeCost: 250, Upkeep: 3},
			{Name: "Barn", Size: 40, BuildCost: 800, UpgradeCost: 600, Upkeep: 8},
			{Name: "Industrial Warehouse", Size: 80, BuildCost: 2000, UpgradeCost: 0, Upkeep: 20},
		},
		ProductionTiers: []Tier{
			{Name: "Kitchen", Size: 10, BuildCost: 500, UpgradeCost: 1000, Upkeep: 10},
			{Name: "Food Truck", Size: 20, BuildCost: 1500, UpgradeCost: 2500, Upkeep: 25},
			{Name: "Bottling Plant", Size: 40, BuildCost: 4000, UpgradeCost: 6000, Upkeep: 60},
			{Name: "Lemonade Factory", Size: 80, BuildCost: 10000, UpgradeCost: 0, Upkeep: 140},
		},
	}
}

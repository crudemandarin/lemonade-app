...
## 12. Balance pass: harder to coast, and upkeep can actually bankrupt you
...
- **Did (numbers):** lemonade base price $100 to $90; price volatility `Sigma` 0.08 to 0.12 and `RevertRate` 0.2 to 0.15; every upkeep value doubled (a new game costs $30/day, was $15). Kept: starting capital, spread, all build and upgrade costs, events (plus the heat-wave/rainy-week exclusion, decision 9).
...
## 13. Price sparklines and the two-chart game timeline

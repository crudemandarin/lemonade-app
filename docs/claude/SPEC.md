...
4. Is username in a header acceptable as "auth"? **Was yes; replaced by Sign in with Google in slice 15** (DECISIONS 32). Usernames are 3 to 40 ASCII characters and case-insensitive (DECISIONS 19).

...
The app is username-only. If you ever set up Google sign-in, none of the scripts remove what it created (the Firebase console pieces were made by hand). Do this after deploying the username-only version, in this order. `PROJECT` below is `lemonade-app-509618` unless you changed it.
